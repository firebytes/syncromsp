...
powershell -ExecutionPolicy Bypass "Set-Variable -Name "subdomain" -Value "firebytes"; (New-Object System.Net.WebClient).DownloadFile('https://github.com/firebytes/syncromsp/raw/master/scripts/support_form.ps1','C:\ProgramData\Syncro\live\scripts\support_form.ps1');C:\ProgramData\Syncro\live\scripts\support_form.ps1"
